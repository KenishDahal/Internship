...
{
    add_meta_box(
        'section1_metabox', // $id is a unique id given to every meta box
        'Section1 Details', // $title is the title displayed in custom meta box
        'section1_metabox_callback', // $callback is a function that outputs markup inside the custom meta box
...
add_action("save_post", "section1_save_metabox_data", 10, 2);

function section1_save_metabox_data($post_id, $post)
{
