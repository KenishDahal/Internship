...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE student SET name='$name',address='$address',email='$email', password='$password' WHERE id='$id' ";
...
$id = isset($_GET['updatedid']) ? $_GET['updatedid'] : '';
...
<body>
    ...
    <form method="post" class="mx-auto w-50" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        <div class="d-flex justify-content-center h2">Update Forms</div>
